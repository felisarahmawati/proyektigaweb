										...
										<div class="row">
											...
											<div class="input-group col-md-8">
												<div class="input-group" style="padding-right: 6px;">
													...
													<input type="text" class="form-control" placeholder="Alamat" value="Indramayu" name="alamat" required>
												</div>
									...
									<div class="form-group form-inline">
										<div class="row">
											...
											<div class="input-group col-md-8">
												<div class="input-group" style="padding-right: 6px;">
													<span class="input-group-addon"><i class="fa fa-circle-o-notch fa-fw"></i></span>
													<input type="text" class="form-control" placeholder="Kelurahan" value="Indramayu" name="kelurahan" required>
												</div>
												<div class="input-group">
													<span class="input-group-addon"><i class="fa fa-circle-o-notch fa-fw"></i></span>
													<input type="text" class="form-control" placeholder="Kecamatan" value="Indramayu" name="kecamatan" required>
												</div>
											</div>
										</div>
									</div>
