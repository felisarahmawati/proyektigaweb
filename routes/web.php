...
Route::middleware(['web', 'auth'])->group(function(){
	...
	Route::middleware(['admin'])->group(function(){
		...
		// Route Panduan
		Route::get('viewPanduan', 'PanduanController@viewPanduan')->name('viewPanduan');
		Route::get('listPrint', 'PanduanController@listPanduan')->name('listPrint');
		Route::post('storePanduan', 'PanduanController@storePanduan')->name('storePanduan');
		Route::get('editPanduan/{id}', 'PanduanController@editPanduan')->name('editPanduan');
		Route::post('updatePanduan/{id}', 'PanduanController@updatePanduan')->name('updatePanduan');
		Route::get('deletePanduan/{id}', 'PanduanController@deletePanduan')->name('deletePanduan');
	...
	// Route::get('/user/panduan/Mapel', 'userController@showMateripanduan')->middleware('role:user');
	// Route::get('/user/panduan/List/{id}', 'userController@showPanduanList')->middleware('role:user');
